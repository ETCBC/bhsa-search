const configData = {
 ...
 "defs": {
  "lsVersion": "v091@2022-01-06T09:23:45",
  "client": "structure",
  "org": "etcbc",
  "repo": "bhsa",
  "urls": {
   ...
   "datadoc": [
    ...
    "https://etcbc./bhsa/features/0_home/",
   ...
   "source": [
    "bhsa-search",
    "https://github.com/etcbc/bhsa-search/tree/master/layeredsearch",
    "source code of the definition of this search interface"
   ],
   "issue": [
    "Report an issue",
    "https://github.com/etcbc/bhsa-search/issues",
    "report issues"
   ],
   "package": [
    "download",
